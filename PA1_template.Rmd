...
Githud repo with RMarkdown Source Code:github.com/nababomo/RepData_PeerAssessment1
...
- Create a new factor variable with two levels: 1. weekday 2. weekends -Subset by each factor. -Aggregate the mean. -Bind both sets.
```{r, echo = TRUE}
